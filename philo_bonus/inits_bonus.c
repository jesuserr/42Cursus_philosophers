...
/*   Updated: 2023/08/23 15:01:51 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_semaphores(t_info *info)
{
	...
	info->forks_sem = sem_open("forks_sem", O_CREAT | O_EXCL, S_IRWXU, info->nbr_philos);
...
{
	if (pthread_create(&info->gen_monitor, NULL, &monitoring, (void *) info) != 0)
